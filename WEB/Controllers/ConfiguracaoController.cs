...
namespace WEB.Controllers
{
    public class ConfiguracaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DiaDeLocacao")] Configuracao configuracao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DiaDeLocacao")] Configuracao configuracao)
        {
